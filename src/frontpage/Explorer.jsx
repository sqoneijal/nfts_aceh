...
const Explorer = () => {
   ...
   const getDaftarKategori = () => {
      ...
      get("/explorer/getdaftarkategori")
         .then((res) => {
            const { data } = res;
                                 ...
                                 <div className="creators space-x-10">
                                    <div className="avatars space-x-3">
                                       <a href={`/creators/detail/${data.id}`}>
                                          <img src={`/assets/images/${data.avatar}`} alt="Avatar" className="avatar avatar-sm" loading="lazy" />
                                       </a>
                                       <a href={`/creators/detail/${data.id}`}>
               ...
               {showLoadMoreButton ? (
                  <div className="d-flex justify-content-center">
                     ...
                     >
                        ...
                        {isLoadingLoadMore ? "Loading..." : `View more Creators & NFTs`}
                     </a>
                  </div>
               ) : (
                  ""
